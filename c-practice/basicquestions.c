...
// • Swap Two Variables : Swap the values of two variables without using a third
//                             variable.
// • Count Vowels and Consonants : Count the number of vowels and consonants in a
//                                      string.
// • Find the Largest Element in an Array : Find the largest element in an array.
// • Calculate Area and Perimeter : Calculate the area and perimeter of a rectangle.
...
// • Calculate Factorial using Recursion : Calculate factorial using a recursive
//                                              function.
// • String Reversal without Library Function : Reverse a string without using library
//                                                   functions.
...
// • GCD(Greatest Common Divisor) : Find the greatest common divisor of two
//                                   numbers.
// • LCM(Least Common Multiple) : Find the least common multiple of two numbers.
// • Find Missing Number : Find the missing number in an array of consecutive
//                          integers.
...
//                        .
// • Calculator Program : Create a simple calculator program with basic operations.
...
// • Check if a String Contains a Substring : Check if a string contains a specified
//                                             substring.
// • Implement a Stack : Implement a stack data structure.
// • Implement a Queue : Implement a queue data structure.
// • Linked List Operations : Implement basic linked list operations(insertion,
//                                                                    deletion)
//                        .
// • Calculate Nth Fibonacci Number : Calculate the Nth Fibonacci number using
//                                     dynamic programming.
...
// • Find the Intersection of Two Linked Lists : Find the intersection point of two
//                                                linked lists.
